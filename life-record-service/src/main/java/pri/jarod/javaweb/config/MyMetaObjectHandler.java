...
public class MyMetaObjectHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        if (hasCreateTime){
            ...
            this.setInsertFieldValByName("createBy", UserInfoHolder.getUserInfoOrEmpty().getAccount(), metaObject);
        }
    ...
    public void updateFill(MetaObject metaObject) {
        ...
        if (fieldValue == null){
            ...
            this.setUpdateFieldValByName("updateBy", UserInfoHolder.getUserInfoOrEmpty().getAccount(), metaObject);
        }
    }
}